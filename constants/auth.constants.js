...
// books
export const BOOK_CREATED_SUCCESS = 'Book created successfully';
export const GET_BOOKS_SUCCESS = 'Book/s fetched successfully';
export const BOOK_UPDATED_SUCCESS = 'Book updated successfully';
export const BOOK_DELETED_SUCCESS = 'Book deleted successfully';
